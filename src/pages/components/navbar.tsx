          ...
          <div className={`container`}>
            ...
            <div className={`${isNavCollapsed ? 'collapse' : ''} navbar-collapse`} id="navbarNavDropdown">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className={`nav-item dropdown mega-dropdown ${isDropdownOpen ? 'show' : ''}`}>
                  {/* Prevent default to stop link navigation */}
                  <Link className="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" onClick={handleToggleDropdown} onMouseEnter={handleMouseEnterDropdown} aria-expanded={isDropdownOpen}>
                    Courses
                  </Link>
                  <div className={`dropdown-menu${isDropdownOpen ? ' show' : ''}`} aria-labelledby="navbarDropdownMenuLink" onMouseLeave={handleMouseLeaveDropdown}>
                    <div className="container-fluid">
                      <div className="row">
                        <div className="col-xs-12">
                          <h6 className="dropdown-header">Technology</h6>
                          <Link className="dropdown-item" href="#">Web Development</Link>
                          <Link className="dropdown-item" href="#">Data Science</Link>
                          <Link className="dropdown-item" href="#">Cyber Security</Link>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <li className="nav-item">
                  <Link className="nav-link" href="mailto:rep@learnly.com">Contact</Link>
                </li>
              </ul>
