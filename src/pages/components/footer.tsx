      ...
      <div className="container text-center text-md-left">
        <div className="row text-center text-md-left py-5">
          ...
          <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
              Learnly empowers learners worldwide with access to an expansive
              library of online courses covering various subjects. Join our
              community to start your journey towards knowledge and skill
              development today.
            </p>
          </div>
        ...
        <div className="footer-wrapper">
          <div className="col-md-7 col-lg-8">
            <p className="text-left text-md-left float-left">
