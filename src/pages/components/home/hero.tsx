    ...
    <section className="p-3 bg-white text-white container-fluid d-flex justify-content-center align-items-center" id='heroSection'>
      <div className="text-center container">
        ...
        <div className="d-flex justify-content-center">
          ...
          <Link href="/browse-courses" className={`btn btn-outline-light ${windowWidth > 1024 ? 'btn-lg' : 'btn-md' } me-2`}>Browse Courses
          </Link>
          <Link href="/join-now" className={`btn btn-warning ${windowWidth > 1024 ? 'btn-lg' : 'btn-md' }`}>Join Now
          </Link>
        </div>
      </div>
    </section>
