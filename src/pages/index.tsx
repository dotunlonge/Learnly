  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learnly offers unlimited access to a wide range of online courses across various subjects. Join today and start learning at your own pace!" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className={`d-flex flex-column justify-content-between align-items-center p-0 m-0 min-vh-100 w-100`}>
        <Navbar />
        <HeroSection />
        <FeaturesSection />
        <TestimonialsSection />
