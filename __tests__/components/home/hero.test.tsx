...
jest.mock('next/link', () => ({ children }: React.PropsWithChildren) => children);
...
describe('Hero Section On Homepage', () => {
  ...
  test('renders the component with a subheadline', () => {
    const subheadline = screen.getByText(/dive into expert-led courses and accelerate your career today\./i);
